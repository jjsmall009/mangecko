...
################################################################################
## Form generated from reading UI file 'add_library_dialogDblwVa.ui'
##
...
class Ui_AddLibraryDialog(object):
    def setupUi(self, AddLibraryDialog):
        ...
        AddLibraryDialog.resize(800, 600)
        font = QFont()
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 780, 488))
        ...
        if (self.series_table.columnCount() < 3):
    ...
    def retranslateUi(self, AddLibraryDialog):
        ...
        ___qtablewidgetitem1.setText(QCoreApplication.translate("AddLibraryDialog", u"Volumes", None));
        ___qtablewidgetitem2 = self.series_table.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("AddLibraryDialog", u"Stuff", None));
