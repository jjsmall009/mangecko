...
################################################################################
## Form generated from reading UI file 'scan_dialogeDVGLw.ui'
##
...
class Ui_ScanDialog(object):
    def setupUi(self, ScanDialog):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 632, 179))
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QRect(0, 0, 632, 178))
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QRect(0, 0, 632, 179))
        ...
        self.info_label = QLabel(ScanDialog)
